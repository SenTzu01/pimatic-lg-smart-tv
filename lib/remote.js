...
Remote.prototype.getInput = function( callback ) {
	...
	this.cmd("input_", "request", "ssap://com.webos.applicationManager/getForegroundAppInfo", null, function( err, input ){
		if( err ) return callback( err, null );
		if( input.errorText ) return callback( input.errorText, null );
...
*/
Remote.prototype.getApp = function( callback ) {
	callback = callback || function(){}

	this.cmd("launcher_", "request", "ssap://com.webos.applicationManager/getForegroundAppInfo", null, function( err, app ){
		if( err ) return callback( err, null );
		if( app.errorText ) return callback( app.errorText, null );
...
emote.prototype.showNotificationModal = function(message, title, callback) {
	callback = callback || function(){}
	this.cmd("", "request", "ssap://system.notifications/createAlert", {
		"title": title,
		"message": message,
		"modal": true,
		"type": "confirm",
